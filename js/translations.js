export const TRANSLATIONS = {
    ES: {
        ...
        trivial: 'trivial',
        trivialExplanation:
            'Un encuentro trivial no presenta peligro alguno para los personajes. Además, sus recursos no deberían verse afectados por este encuentro.',
        easy: 'fácil',
        easyExplanation:
            'Un encuentro fácil no consumirá los recursos de los personajes ni les pondrá realmente en peligro. Puede que pierdan unos cuantos puntos de golpe, pero su victoria estará, casi con total seguridad, garantizada.',
        medium: 'media',
        mediumExplanation:
            'Un encuentro de dificultad media puede dar un susto o dos a los personajes, pero estos deberían salir victoriosos sin sufrir baja alguna. Es probable que uno o más aventureros tengan que consumir recursos para curarse.',
        hard: 'dificil',
        hardExplanation:
        ...
        lessThan: 'Menor a',
        from: 'Desde',
        avgPartyLevel: 'Nivel promedio del grupo',
        totalXP: 'XP total',
    ...
    EN: {
        ...
        trivial: 'trivial',
        trivialExplanation:
            'A trivial encounter presents no danger to the characters. Also, their resources should not be affected by this encounter.',
        easy: 'easy',
        easyExplanation:
        ...
        lessThan: 'Less than',
        from: 'From',
        avgPartyLevel: 'Average party level',
        totalXP: 'Total XP',
